...
//	}
	...
	//	static Vector3 RotateVector2(const Vector3 &v, float angle, Vector3 axisVec)
	//{
	//const double PI = 3.1415926535897932384626433832795;
	//	/*angle *= -(float)PI / 180;
	//	axisVec.Normalize();
	...
	/*void RotateAround2(float angleDegrees, Vector3 axis)
	{
		Vector3 meRotated = RotateVector2(*this, angleDegrees, axis);
		Set(meRotated);
	}*/
};
#endif